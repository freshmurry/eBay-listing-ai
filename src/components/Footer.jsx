...
const socialLinks = [
  ...
  { name: "GitHub", href: "https://github.com/ebaylistingai", icon: Github },
  { name: "Email", href: "mailto:info@ebaylistingdescriptionai.com", icon: Mail },
];
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-5">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-600 mb-4">
              AI-powered eBay listing generator that creates compelling product descriptions, 
